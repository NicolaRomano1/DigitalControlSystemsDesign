...
function [y,u,Du,r] = mpc_simulate_outputconstraints_osqp(B,A,nu,ny,Wu,Wy,Dumax,umax,umin,ymax,ymin,ref,dist,noise)
...
%% This is the modified part that uses osqp instead of quadprog
problem = osqp;
lower =  [-inf * ones(1,28)]';
problem.setup(S, f, CC, lower,dt);
